      ...
      <div class="row wrapper border-bottom page-heading">
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"> <strong> All Categories </strong> </li>
          </ol>
        </div>
      </div>
      <div class="row">
                ...
                <div >
                  <table id="example7" class="display nowrap table  responsive nowrap table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>{{$category->id}}</td>
                        {{-- <td><img class="image_fade" src="{{ asset('/storage/city_images/'. $category->city_image)}}" alt="Standard Post with Image" height="50px;" width="50px;"></td> --}}
                        <td>{{$category->name}}</td>
                        <td><a href = "/admin/category/list/single-category/{{$category->id}}" target="_blank">View</a></td>
                        <td><a href = "/admin/category/edit-category/{{$category->id}}" target="_blank">EDIT</a></td>
