      ...
      <div class="row wrapper border-bottom page-heading">
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            ...
            <li> <a>Products</a> </li>
            <li class="active"> <strong> All Products </strong> </li>
          </ol>
        </div>
      </div>
      <div class="row">
                ...
                <div >
                  <table id="example7" class="display nowrap table  responsive nowrap table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>{{$product->id}}</td>
                        {{-- <td><img class="image_fade" src="{{ asset('/storage/city_images/'. $product->city_image)}}" alt="Standard Post with Image" height="50px;" width="50px;"></td> --}}
                        <td>{{$product->name}}</td>
                        <td>{{$product->sku}}</td>
                        <td>{{$product->category['name']}}</td>
                        <td>{{$product->price}}</td>
                        <td><a href = "/admin/products/list/single-product/{{$product->id}}" target="_blank">View</a></td>
                        <td><a href = "/admin/products/edit-product/{{$product->id}}" target="_blank">EDIT</a></td>
